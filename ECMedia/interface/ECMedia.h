...
* @return 成功返回0，失败返回非0
*/
ECMEDIA_API int ECMedia_set_remote_i420_framecallback(int channelid, yuntongxunwebrtc::ECMedia_I420FrameCallBack callback);
 ...
 */
ECMEDIA_API int ECMedia_iOS_SetVideoFilter(int deviceid, yuntongxunwebrtc::ECImageFilterType filter);
/* 
// 播流接口调用流程
// 创建 handle
