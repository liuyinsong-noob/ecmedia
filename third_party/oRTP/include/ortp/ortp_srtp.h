...
ORTP_PUBLIC err_status_tt ortp_srtp_init(void);
ORTP_PUBLIC err_status_tt ortp_srtp_create(srtp_t *session, const srtp_policy_t *policy);
ORTP_PUBLIC err_status_tt ortp_srtp_dealloc(srtp_t session);
ORTP_PUBLIC err_status_tt ortp_srtp_add_stream(srtp_t session, const srtp_policy_t *policy);
ORTP_PUBLIC err_status_tt ortp_crypto_get_random(uint8_t *tmp, int size);
