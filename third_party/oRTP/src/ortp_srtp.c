...
err_status_tt ortp_srtp_init(void)
{
...
err_status_tt ortp_srtp_create(srtp_t *session, const srtp_policy_t *policy)
{
	int i;
...
err_status_tt ortp_srtp_dealloc(srtp_t session)
{
	return srtp_dealloc(session);
}

err_status_tt ortp_srtp_add_stream(srtp_t session, const srtp_policy_t *policy)
{
...
err_status_tt ortp_crypto_get_random(uint8_t *tmp, int size)
{
...
err_status_tt ortp_srtp_create(srtp_t *i, const srtp_policy_t *policy)
{
	return -1;
}
