...
static av_cold int ilbc_decode_init(AVCodecContext *avctx)
{
    ...
    CloopenWebRtcIlbcfix_InitDecode(&s->decoder, mode, s->enhance);
                             ...
                             int *got_frame_ptr, AVPacket *avpkt)
{
    ...
    CloopenWebRtcIlbcfix_DecodeImpl((WebRtc_Word16*) frame->data[0],
...
static av_cold int ilbc_encode_init(AVCodecContext *avctx)
{
    ...
    CloopenWebRtcIlbcfix_InitEncode(&s->encoder, s->mode);
                             ...
                             const AVFrame *frame, int *got_packet_ptr)
{
    ...
    CloopenWebRtcIlbcfix_EncodeImpl((WebRtc_UWord16*) avpkt->data, (const WebRtc_Word16*) frame->data[0], &s->encoder);
