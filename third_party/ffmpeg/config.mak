...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --arch=armv7-a --enable-version3 --disable-everything --enable-decoder=h264 --enable-small --enable-gpl --enable-nonfree --disable-stripping --disable-ffmpeg --disable-ffplay --disable-ffserver --disable-ffprobe --disable-encoders --disable-muxers --disable-devices --disable-protocols --enable-protocol=file --enable-avfilter --disable-network --disable-avdevice --enable-cross-compile --cc='/work/android/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc --sysroot=/work/android/android-ndk-r8e/platforms/android-9/arch-arm' --nm=/work/android/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-nm --extra-cflags='-fPIC -DANDROID -fno-exceptions 	-Wno-psabi 	-Wno-missing-field-initializers 	-fno-strict-aliasing 	-fvisibility=hidden 	-pipe 	-fPIC 	-Wextra 	-fno-tree-sra 	-D__linux__ 	-ffunction-sections 	-funwind-tables 	-mthumb 	-mthumb-interwork 	-g 	-fstack-protector 	-fno-short-enums 	-finline-limit=64 	-Wa,--noexecstack 	-Wno-error=non-virtual-dtor 	-Os 	-fno-ident 	-fdata-sections 	-ffunction-sections 	-fomit-frame-pointer' --extra-libs=-lgcc --disable-asm --enable-neon --enable-armv5te --prefix=/Users/leesean/Desktop/newffmpeg/ffmpeg/ffmpeg-android-bin --cross-prefix=/work/android/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/darwin-x86_64/bin/arm-linux-androideabi- --extra-ldflags='-march=arvm7-a -Wl,-T,/work/android/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/darwin-x86_64/arm-linux-androideabi/lib/ldscripts/armelf_linux_eabi.x -Wl,-rpath-link=/work/android/android-ndk-r8e/platforms/android-8/arch-arm/usr/lib -L/work/android/android-ndk-r8e/platforms/android-8/arch-arm/usr/lib -nostdlib /work/android/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/darwin-x86_64/lib/gcc/arm-linux-androideabi/4.4.3/crtbegin.o /work/android/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/darwin-x86_64/lib/gcc/arm-linux-androideabi/4.4.3/crtend.o -lc -lm -ldl -lgcc'
...
ARCH=c
CC=/work/android/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc --sysroot=/work/android/android-ndk-r8e/platforms/android-9/arch-arm
CXX=/work/android/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-g++
AS=/work/android/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc --sysroot=/work/android/android-ndk-r8e/platforms/android-9/arch-arm
LD=/work/android/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc --sysroot=/work/android/android-ndk-r8e/platforms/android-9/arch-arm
DEPCC=/work/android/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc --sysroot=/work/android/android-ndk-r8e/platforms/android-9/arch-arm
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/work/android/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc --sysroot=/work/android/android-ndk-r8e/platforms/android-9/arch-arm
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=/work/android/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-ar
ARFLAGS=rc
AR_O=$@
RANLIB=/work/android/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-ranlib
CP=cp -p
LN_S=ln -s -f
STRIP=echo skipping strip
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
CFLAGS=  -fPIC -DANDROID -fno-exceptions -Wno-psabi -Wno-missing-field-initializers -fno-strict-aliasing -fvisibility=hidden -pipe -fPIC -Wextra -fno-tree-sra -D__linux__ -ffunction-sections -funwind-tables -mthumb -mthumb-interwork -g -fstack-protector -fno-short-enums -finline-limit=64 -Wa,--noexecstack -Wno-error=non-virtual-dtor -Os -fno-ident -fdata-sections -ffunction-sections -fomit-frame-pointer -march=armv5te -std=c99 -fomit-frame-pointer -fPIC -mthumb -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -fPIC -DANDROID -fno-exceptions -Wno-psabi -Wno-missing-field-initializers -fno-strict-aliasing -fvisibility=hidden -pipe -fPIC -Wextra -fno-tree-sra -D__linux__ -ffunction-sections -funwind-tables -mthumb -mthumb-interwork -g -fstack-protector -fno-short-enums -finline-limit=64 -Wa,--noexecstack -Wno-error=non-virtual-dtor -Os -fno-ident -fdata-sections -ffunction-sections -fomit-frame-pointer -march=armv5te -fPIC -g
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
LDFLAGS= -march=arvm7-a -Wl,-T,/work/android/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/darwin-x86_64/arm-linux-androideabi/lib/ldscripts/armelf_linux_eabi.x -Wl,-rpath-link=/work/android/android-ndk-r8e/platforms/android-8/arch-arm/usr/lib -L/work/android/android-ndk-r8e/platforms/android-8/arch-arm/usr/lib -nostdlib /work/android/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/darwin-x86_64/lib/gcc/arm-linux-androideabi/4.4.3/crtbegin.o /work/android/android-ndk-r8e/toolchains/arm-linux-androideabi-4.4.3/prebuilt/darwin-x86_64/lib/gcc/arm-linux-androideabi/4.4.3/crtend.o -lc -lm -ldl -lgcc  -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
