...
NSString *const kECImageSoftLightBlendFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageSoftLightBlendFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageSoftLightBlendFragmentShaderString]))
    {
		return nil;
    }
