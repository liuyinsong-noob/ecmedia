...
NSString *const kECImagePixellationPositionFragmentShaderString = SHADER_STRING
(
...
@interface ECImagePixellatePositionFilter ()
...
@implementation ECImagePixellatePositionFilter
...
- (id)init;
{
    if (!(self = [self initWithFragmentShaderFromString:kECImagePixellationPositionFragmentShaderString]))
    {
		return nil;
    }
