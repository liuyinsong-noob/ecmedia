...
NSString *const kECImageLookupFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageLookupFilter
...
- (id)init;
{
    ...
    if (!(self = [super initWithFragmentShaderFromString:kECImageLookupFragmentShaderString]))
    {
		return nil;
    }
