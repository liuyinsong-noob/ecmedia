...
NSString *const kECImageLineGeneratorVertexShaderString = SHADER_STRING
(
...
NSString *const kECImageLineGeneratorFragmentShaderString = SHADER_STRING
(
...
@interface ECImageLineGenerator()

- (void)generateLineCoordinates;

@end

@implementation ECImageLineGenerator
...
- (id)init;
{
    if (!(self = [super initWithVertexShaderFromString:kECImageLineGeneratorVertexShaderString fragmentShaderFromString:kECImageLineGeneratorFragmentShaderString]))
    {
        return nil;
    }
