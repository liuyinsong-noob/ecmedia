...
NSString *const kECImageLuminosityBlendFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageLuminosityBlendFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageLuminosityBlendFragmentShaderString]))
    {
		return nil;
    }
