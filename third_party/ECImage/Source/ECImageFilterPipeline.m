...
@interface ECImageFilterPipeline ()
...
@implementation ECImageFilterPipeline
...
- (BOOL)_parseConfiguration:(NSDictionary *)configuration {
    ...
    for (NSDictionary *filter in filters) {
        ...
        ECImageOutput<ECImageInput> *genericFilter = [[theClass alloc] init];
...
- (void)_refreshFilters {
    ...
    ECImageOutput<ECImageInput> *theFilter = nil;
...
- (UIImage *)currentFilteredFrame {
    return [(ECImageOutput<ECImageInput> *)[_filters lastObject] imageFromCurrentFramebuffer];
}

- (UIImage *)currentFilteredFrameWithOrientation:(UIImageOrientation)imageOrientation {
  return [(ECImageOutput<ECImageInput> *)[_filters lastObject] imageFromCurrentFramebufferWithOrientation:imageOrientation];
}

- (CGImageRef)newCGImageFromCurrentFilteredFrame {
    return [(ECImageOutput<ECImageInput> *)[_filters lastObject] newCGImageFromCurrentlyProcessedOutput];
}
