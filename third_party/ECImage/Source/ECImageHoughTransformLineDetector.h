...
@interface ECImageHoughTransformLineDetector : ECImageFilterGroup
{
    ECImageOutput<ECImageInput> *thresholdEdgeDetectionFilter;
    
//    ECImageThresholdEdgeDetectionFilter *thresholdEdgeDetectionFilter;
    ECImageParallelCoordinateLineTransformFilter *parallelCoordinateLineTransformFilter;
