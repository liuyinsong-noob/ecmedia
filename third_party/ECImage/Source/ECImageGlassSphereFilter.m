...
NSString *const kECImageGlassSphereFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageGlassSphereFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageGlassSphereFragmentShaderString]))
    {
		return nil;
    }
