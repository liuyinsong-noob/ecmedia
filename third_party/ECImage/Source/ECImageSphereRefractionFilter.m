...
NSString *const kECImageSphereRefractionFragmentShaderString = SHADER_STRING
(
...
@interface ECImageSphereRefractionFilter ()
...
@implementation ECImageSphereRefractionFilter
...
- (id)init;
{
    if (!(self = [self initWithFragmentShaderFromString:kECImageSphereRefractionFragmentShaderString]))
    {
		return nil;
    }
