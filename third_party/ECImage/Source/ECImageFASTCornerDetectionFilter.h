...
@class ECImage3x3TextureSamplingFilter;
@class ECImageNonMaximumSuppressionFilter;
...
typedef enum { kECImageFAST12Contiguous, kECImageFAST12ContiguousNonMaximumSuppressed} ECImageFASTDetectorType;

@interface ECImageFASTCornerDetectionFilter : ECImageFilterGroup
{
    ECImageGrayscaleFilter *luminanceReductionFilter;
    ECImage3x3TextureSamplingFilter *featureDetectionFilter;
    ECImageNonMaximumSuppressionFilter *nonMaximumSuppressionFilter;
...
- (id)initWithFASTDetectorVariant:(ECImageFASTDetectorType)detectorType;
