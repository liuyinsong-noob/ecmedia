...
NSString *const kECImageLanczosVertexShaderString = SHADER_STRING
(
...
NSString *const kECImageLanczosFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageLanczosResamplingFilter
...
- (id)init;
{
    if (!(self = [super initWithFirstStageVertexShaderFromString:kECImageLanczosVertexShaderString firstStageFragmentShaderFromString:kECImageLanczosFragmentShaderString secondStageVertexShaderFromString:kECImageLanczosVertexShaderString secondStageFragmentShaderFromString:kECImageLanczosFragmentShaderString]))
    {
		return nil;
    }
...
- (void)renderToTextureWithVertices:(const GLfloat *)vertices textureCoordinates:(const GLfloat *)textureCoordinates;
{
    ...
    outputFramebuffer = [[ECImageContext sharedFramebufferCache] fetchFramebufferForSize:currentFBOSize textureOptions:self.outputTextureOptions onlyTexture:NO];
    ...
    glBindTexture(GL_TEXTURE_2D, 0);
    secondOutputFramebuffer = [[ECImageContext sharedFramebufferCache] fetchFramebufferForSize:[self sizeOfFBO] textureOptions:self.outputTextureOptions onlyTexture:NO];
    ...
    glVertexAttribPointer(secondFilterTextureCoordinateAttribute, 2, GL_FLOAT, 0, 0, [[self class] textureCoordinatesForRotation:kECImageNoRotation]);
