...
NSString *const kECImageLaplacianFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageLaplacianFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageLaplacianFragmentShaderString]))
    {
		return nil;
    }
