...
NSString *const kECImageSaturationBlendFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageSaturationBlendFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageSaturationBlendFragmentShaderString]))
    {
		return nil;
    }
