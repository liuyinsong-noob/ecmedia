...
NSString *const kECImagePinchDistortionFragmentShaderString = SHADER_STRING
(
...
@interface ECImagePinchDistortionFilter ()
...
@implementation ECImagePinchDistortionFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImagePinchDistortionFragmentShaderString]))
    {
		return nil;
    }
