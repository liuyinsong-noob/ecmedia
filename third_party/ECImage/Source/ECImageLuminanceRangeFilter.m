...
NSString *const kECImageLuminanceRangeFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageLuminanceRangeFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageLuminanceRangeFragmentShaderString]))
    {
		return nil;
    }
