...
NSString *const kECImagePolarPixellateFragmentShaderString = SHADER_STRING
(
...
@implementation ECImagePolarPixellateFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImagePolarPixellateFragmentShaderString]))
    {
		return nil;
    }
