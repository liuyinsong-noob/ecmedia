...
NSString *const kECImageTiltedTexelSamplingVertexShaderString = SHADER_STRING
(
...
NSString *const kECImageMotionBlurFragmentShaderString = SHADER_STRING
(
...
@interface ECImageMotionBlurFilter()
{
...
@implementation ECImageMotionBlurFilter
...
- (id)init;
{
    if (!(self = [super initWithVertexShaderFromString:kECImageTiltedTexelSamplingVertexShaderString fragmentShaderFromString:kECImageMotionBlurFragmentShaderString]))
    {
        return nil;
    }
