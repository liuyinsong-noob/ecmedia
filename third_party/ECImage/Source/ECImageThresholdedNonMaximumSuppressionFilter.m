...
NSString *const kECImageThresholdedNonMaximumSuppressionFragmentShaderString = SHADER_STRING
(
...
NSString *const kECImageThresholdedNonMaximumSuppressionPackedColorspaceFragmentShaderString = SHADER_STRING
(
 uniform sampler2D inputImageTexture;
...
@implementation ECImageThresholdedNonMaximumSuppressionFilter
...
- (id)initWithPackedColorspace:(BOOL)inputUsesPackedColorspace;
{
    ...
    {
        shaderString = kECImageThresholdedNonMaximumSuppressionPackedColorspaceFragmentShaderString;
    }
    else
    {
        shaderString = kECImageThresholdedNonMaximumSuppressionFragmentShaderString;
    }
