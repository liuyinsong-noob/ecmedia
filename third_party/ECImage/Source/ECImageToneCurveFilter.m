...
#pragma mark -
#pragma mark ECImageACVFile Helper
...
@interface ECImageACVFile : NSObject{
    short version;
    short totalCurves;
...
#pragma mark -
#pragma mark ECImageToneCurveFilter Implementation

#if TARGET_IPHONE_SIMULATOR || TARGET_OS_IPHONE
NSString *const kECImageToneCurveFragmentShaderString = SHADER_STRING
(
...
@interface ECImageToneCurveFilter()
{
...
@implementation ECImageToneCurveFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageToneCurveFragmentShaderString]))
    {
		return nil;
    }
...
- (id)initWithACVData:(NSData *)data {
    ...
    ECImageACVFile *curve = [[ECImageACVFile alloc] initWithACVFileData:data];
...
{
    NSData* fileData = [NSData dataWithContentsOfURL:curveFileURL];
    ECImageACVFile *curve = [[ECImageACVFile alloc] initWithACVFileData:fileData];
