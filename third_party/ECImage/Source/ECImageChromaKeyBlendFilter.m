...
NSString *const kECImageChromaKeyBlendFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageChromaKeyBlendFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageChromaKeyBlendFragmentShaderString]))
    {
		return nil;
    }
