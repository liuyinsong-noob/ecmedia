...
NSString *const kECImage3x3ConvolutionFragmentShaderString = SHADER_STRING
(
...
@implementation ECImage3x3ConvolutionFilter
...
- (id)init;
{
    if (!(self = [self initWithFragmentShaderFromString:kECImage3x3ConvolutionFragmentShaderString]))
    {
		return nil;
    }
