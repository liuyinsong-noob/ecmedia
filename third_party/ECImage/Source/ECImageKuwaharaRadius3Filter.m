...
NSString *const kECImageKuwaharaRadius3FragmentShaderString = SHADER_STRING
(
...
@implementation ECImageKuwaharaRadius3Filter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageKuwaharaRadius3FragmentShaderString]))
    {
		return nil;
    }
