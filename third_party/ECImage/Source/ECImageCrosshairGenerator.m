...
NSString *const kECImageCrosshairVertexShaderString = SHADER_STRING
(
...
NSString *const kECImageCrosshairFragmentShaderString = SHADER_STRING
(
...
NSString *const kECImageCrosshairFragmentShaderString = SHADER_STRING
(
 ECImageEscapedHashIdentifier(version 120)\n
...
@implementation ECImageCrosshairGenerator
...
- (id)init;
{
    if (!(self = [super initWithVertexShaderFromString:kECImageCrosshairVertexShaderString fragmentShaderFromString:kECImageCrosshairFragmentShaderString]))
    {
        return nil;
    }
