...
@class ECImageGaussianBlurFilter;
@class ECImageXYDerivativeFilter;
@class ECImageGrayscaleFilter;
@class ECImageGaussianBlurFilter;
@class ECImageThresholdedNonMaximumSuppressionFilter;
@class ECImageColorPackingFilter;

//#define DEBUGFEATUREDETECTION

/** Harris corner detector
 
 First pass: reduce to luminance and take the derivative of the luminance texture (ECImageXYDerivativeFilter)
 
 Second pass: blur the derivative (ECImageGaussianBlurFilter)
 ...
 */
@interface ECImageHarrisCornerDetectionFilter : ECImageFilterGroup
{
    ECImageXYDerivativeFilter *derivativeFilter;
    ECImageGaussianBlurFilter *blurFilter;
    ECImageFilter *harrisCornerDetectionFilter;
    ECImageThresholdedNonMaximumSuppressionFilter *nonMaximumSuppressionFilter;
    ECImageColorPackingFilter *colorPackingFilter;
