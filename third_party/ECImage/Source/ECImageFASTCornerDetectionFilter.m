#import "ECImageFASTCornerDetectionFilter.h"
...
NSString *const kECImageFASTDetectorFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageFASTCornerDetectionFilter

- (id)init;
{
    if (!(self = [self initWithFASTDetectorVariant:kECImageFAST12ContiguousNonMaximumSuppressed]))
    {
        return nil;
    }
