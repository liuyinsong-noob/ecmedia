...
@implementation ECImageXYDerivativeFilter

#if TARGET_IPHONE_SIMULATOR || TARGET_OS_IPHONE
NSString *const kECImageGradientFragmentShaderString = SHADER_STRING
(
...
- (id)init;
{
    if (!(self = [self initWithFragmentShaderFromString:kECImageGradientFragmentShaderString]))
    {
		return nil;
    }
