...
NSString *const kECImageKuwaharaFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageKuwaharaFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageKuwaharaFragmentShaderString]))
    {
		return nil;
    }
