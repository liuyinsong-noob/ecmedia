...
NSString *const kECImageVignetteFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageVignetteFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageVignetteFragmentShaderString]))
    {
		return nil;
    }
