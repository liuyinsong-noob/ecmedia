//
//  ECImageCGAColorspaceFilter.m
//

#import "ECImageCGAColorspaceFilter.h"

#if TARGET_IPHONE_SIMULATOR || TARGET_OS_IPHONE
NSString *const kECImageCGAColorspaceFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageCGAColorspaceFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageCGAColorspaceFragmentShaderString]))
    {
		return nil;
    }
