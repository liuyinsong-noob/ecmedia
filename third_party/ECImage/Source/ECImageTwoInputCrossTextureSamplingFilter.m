...
NSString *const kECImageTwoInputNearbyTexelSamplingVertexShaderString = SHADER_STRING
(
...
@implementation ECImageTwoInputCrossTextureSamplingFilter
...
{
    if (!(self = [super initWithVertexShaderFromString:kECImageTwoInputNearbyTexelSamplingVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
        return nil;
    }
