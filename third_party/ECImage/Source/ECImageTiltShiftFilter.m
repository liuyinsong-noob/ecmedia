...
NSString *const kECImageTiltShiftFragmentShaderString = SHADER_STRING
( 
...
@implementation ECImageTiltShiftFilter
...
- (id)init;
{
    ...
    tiltShiftFilter = [[ECImageTwoInputFilter alloc] initWithFragmentShaderFromString:kECImageTiltShiftFragmentShaderString];
