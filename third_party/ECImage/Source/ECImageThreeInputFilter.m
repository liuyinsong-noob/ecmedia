...
NSString *const kECImageThreeInputTextureVertexShaderString = SHADER_STRING
(
...
@implementation ECImageThreeInputFilter
...
{
    if (!(self = [self initWithVertexShaderFromString:kECImageThreeInputTextureVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
		return nil;
    }
...
- (id)initWithVertexShaderFromString:(NSString *)vertexShaderString fragmentShaderFromString:(NSString *)fragmentShaderString;
{
    ...
    inputRotation3 = kECImageNoRotation;
