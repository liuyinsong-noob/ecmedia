...
NSString *const kECImageHoughAccumulationVertexShaderString = SHADER_STRING
(
...
NSString *const kECImageHoughAccumulationFragmentShaderString = SHADER_STRING
(
...
NSString *const kECImageHoughAccumulationFBOReadFragmentShaderString = SHADER_STRING
(
...
@interface ECImageParallelCoordinateLineTransformFilter()
// Rendering
- (void)generateLineCoordinates;

@end

@implementation ECImageParallelCoordinateLineTransformFilter
...
- (id)init;
{
    ...
    {
        fragmentShaderToUse = [NSString stringWithFormat:@"#extension GL_EXT_shader_framebuffer_fetch : require\n %@",kECImageHoughAccumulationFBOReadFragmentShaderString];
    }
    else
    {
        fragmentShaderToUse = kECImageHoughAccumulationFragmentShaderString;
    }

    if (!(self = [super initWithVertexShaderFromString:kECImageHoughAccumulationVertexShaderString fragmentShaderFromString:fragmentShaderToUse]))
    {
        return nil;
    }
