...
NSString *const kECImageSwirlFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageSwirlFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageSwirlFragmentShaderString]))
    {
		return nil;
    }
