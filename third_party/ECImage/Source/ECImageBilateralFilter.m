...
NSString *const kECImageBilateralBlurVertexShaderString = SHADER_STRING
(
...
NSString *const kECImageBilateralFilterFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageBilateralFilter
...
- (id)init;
{
    ...
    if (!(self = [super initWithFirstStageVertexShaderFromString:kECImageBilateralBlurVertexShaderString
                              firstStageFragmentShaderFromString:kECImageBilateralFilterFragmentShaderString
                               secondStageVertexShaderFromString:kECImageBilateralBlurVertexShaderString
                             secondStageFragmentShaderFromString:kECImageBilateralFilterFragmentShaderString])) {
        return nil;
    }
