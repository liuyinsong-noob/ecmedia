...
NSString *const kECImageGaussianSelectiveBlurFragmentShaderString = SHADER_STRING
( 
...
@implementation ECImageGaussianSelectiveBlurFilter
...
- (id)init;
{
    ...
    selectiveFocusFilter = [[ECImageTwoInputFilter alloc] initWithFragmentShaderFromString:kECImageGaussianSelectiveBlurFragmentShaderString];
