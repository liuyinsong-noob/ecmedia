...
@implementation ECImageLocalBinaryPatternFilter

#if TARGET_IPHONE_SIMULATOR || TARGET_OS_IPHONE
NSString *const kECImageLocalBinaryPatternFragmentShaderString = SHADER_STRING
(
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageLocalBinaryPatternFragmentShaderString]))
    {
		return nil;
    }
