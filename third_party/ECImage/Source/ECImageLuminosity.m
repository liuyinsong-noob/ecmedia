...
NSString *const kECImageInitialLuminosityFragmentShaderString = SHADER_STRING
(
...
NSString *const kECImageLuminosityFragmentShaderString = SHADER_STRING
(
 precision highp float;
...
@implementation ECImageLuminosity
...
- (id)init;
{
    if (!(self = [super initWithVertexShaderFromString:kECImageColorAveragingVertexShaderString fragmentShaderFromString:kECImageInitialLuminosityFragmentShaderString]))
    {
        return nil;
    }
    ...
    __unsafe_unretained ECImageLuminosity *weakSelf = self;
