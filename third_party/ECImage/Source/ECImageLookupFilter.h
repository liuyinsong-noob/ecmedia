...
@interface ECImageLookupFilter : ECImageTwoInputFilter
{
    GLint intensityUniform;
}

// How To Use:
// 1) Use your favourite photo editing application to apply a filter to lookup.png from ECImage/framework/Resources.
...
// E.g. color_balance_lookup_1.png -> ECImageGaussianBlurFilter -> color_balance_lookup_2.png
// 2) Use you new lookup.png file as a second input for ECImageLookupFilter.

// See ECImageAmatorkaFilter, ECImageMissEtikateFilter, and ECImageSoftEleganceFilter for example.
