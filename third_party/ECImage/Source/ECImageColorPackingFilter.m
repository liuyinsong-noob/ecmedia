...
NSString *const kECImageColorPackingVertexShaderString = SHADER_STRING
(
...
NSString *const kECImageColorPackingFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageColorPackingFilter
...
- (id)init;
{
    if (!(self = [super initWithVertexShaderFromString:kECImageColorPackingVertexShaderString fragmentShaderFromString:kECImageColorPackingFragmentShaderString]))
    {
        return nil;
    }
