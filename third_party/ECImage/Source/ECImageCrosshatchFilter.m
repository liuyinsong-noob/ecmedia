...
NSString *const kECImageCrosshatchFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageCrosshatchFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageCrosshatchFragmentShaderString]))
    {
		return nil;
    }
