...
@interface ECImageRawDataInput()
- (void)uploadBytes:(GLubyte *)bytesToUpload;
@end

@implementation ECImageRawDataInput
...
- (void)uploadBytes:(GLubyte *)bytesToUpload;
{
    ...
    outputFramebuffer = [[ECImageContext sharedFramebufferCache] fetchFramebufferForSize:uploadedImageSize textureOptions:self.outputTextureOptions onlyTexture:YES];
