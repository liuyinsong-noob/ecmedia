...
NSString *const kECImageJFAVoronoiVertexShaderString = SHADER_STRING
(
...
NSString *const kECImageJFAVoronoiFragmentShaderString = SHADER_STRING
(
...
@interface ECImageJFAVoronoiFilter() {
    int currentPass;
}
...
@implementation ECImageJFAVoronoiFilter

@synthesize sizeInPixels = _sizeInPixels;

- (id)init;
{
    if (!(self = [super initWithVertexShaderFromString:kECImageJFAVoronoiVertexShaderString fragmentShaderFromString:kECImageJFAVoronoiFragmentShaderString]))
    {
