...
@implementation ECImagePrewittEdgeDetectionFilter

#if TARGET_IPHONE_SIMULATOR || TARGET_OS_IPHONE
NSString *const kECImagePrewittFragmentShaderString = SHADER_STRING
(
...
- (id)init;
{
    if (!(self = [self initWithFragmentShaderFromString:kECImagePrewittFragmentShaderString]))
    {
		return nil;
    }
