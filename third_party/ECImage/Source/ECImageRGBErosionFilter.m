...
NSString *const kECImageRGBErosionRadiusOneFragmentShaderString = SHADER_STRING
(
...
NSString *const kECImageRGBErosionRadiusTwoFragmentShaderString = SHADER_STRING
(
 precision highp float;
...
NSString *const kECImageRGBErosionRadiusThreeFragmentShaderString = SHADER_STRING
(
 precision highp float;
...
NSString *const kECImageRGBErosionRadiusFourFragmentShaderString = SHADER_STRING
(
 precision highp float;
...
@implementation ECImageRGBErosionFilter
...
{    
    ...
    switch (erosionRadius)
    {
        ...
        case 1:
        {
            ...
            fragmentShaderForThisRadius = kECImageRGBErosionRadiusOneFragmentShaderString;
        }; break;
        case 2:
        {
            vertexShaderForThisRadius = kECImageDilationRadiusTwoVertexShaderString;
            fragmentShaderForThisRadius = kECImageRGBErosionRadiusTwoFragmentShaderString;
        }; break;
        case 3:
        {
            vertexShaderForThisRadius = kECImageDilationRadiusThreeVertexShaderString;
            fragmentShaderForThisRadius = kECImageRGBErosionRadiusThreeFragmentShaderString;
        }; break;
        case 4:
        {
            vertexShaderForThisRadius = kECImageDilationRadiusFourVertexShaderString;
            fragmentShaderForThisRadius = kECImageRGBErosionRadiusFourFragmentShaderString;
        }; break;
        default:
        {
            vertexShaderForThisRadius = kECImageDilationRadiusFourVertexShaderString;
