...
NSString *const kECImageBulgeDistortionFragmentShaderString = SHADER_STRING
(
...
@interface ECImageBulgeDistortionFilter ()
...
@implementation ECImageBulgeDistortionFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageBulgeDistortionFragmentShaderString]))
    {
		return nil;
    }
