...
NSString *const kECImageSixInputTextureVertexShaderString = SHADER_STRING
(
...
@implementation ECImageSixInputFilter

- (id)initWithFragmentShaderFromString:(NSString *)fragmentShaderString;
{
    if (!(self = [self initWithVertexShaderFromString:kECImageSixInputTextureVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
        return nil;
    }
...
- (id)initWithVertexShaderFromString:(NSString *)vertexShaderString fragmentShaderFromString:(NSString *)fragmentShaderString;
{
    ...
    inputRotation6 = kECImageNoRotation;
