...
NSString *const kECImageFiveInputTextureVertexShaderString = SHADER_STRING
(
...
@implementation ECImageFiveInputFilter

- (id)initWithFragmentShaderFromString:(NSString *)fragmentShaderString;
{
    if (!(self = [self initWithVertexShaderFromString:kECImageFiveInputTextureVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
        return nil;
    }
...
- (id)initWithVertexShaderFromString:(NSString *)vertexShaderString fragmentShaderFromString:(NSString *)fragmentShaderString;
{
    ...
    inputRotation5 = kECImageNoRotation;
...
- (CGSize)rotatedSize:(CGSize)sizeToRotate forIndex:(NSInteger)textureIndex;
{
    ...
    ECImageRotationMode rotationToCheck;
    if (textureIndex == 0)
    {
