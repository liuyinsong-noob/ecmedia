...
NSString *const kECImageLuminanceThresholdFragmentShaderString = SHADER_STRING
( 
...
@implementation ECImageLuminanceThresholdFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageLuminanceThresholdFragmentShaderString]))
    {
		return nil;
    }
