...
NSString *const kECImageNonMaximumSuppressionFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageNonMaximumSuppressionFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageNonMaximumSuppressionFragmentShaderString]))
    {
        return nil;
    }
