...
NSString *const kECImageMosaicFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageMosaicFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageMosaicFragmentShaderString]))
    {
		return nil;
    }
...
#endif
    pic = [[ECImagePicture alloc] initWithImage:img smoothlyScaleOutput:YES];
    [pic addTarget:self];
    [pic processImage];
}
