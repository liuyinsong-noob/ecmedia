...
NSString *const kECImageRGBFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageRGBFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageRGBFragmentShaderString]))
    {
		return nil;
    }
