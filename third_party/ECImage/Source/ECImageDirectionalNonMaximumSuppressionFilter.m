...
@implementation ECImageDirectionalNonMaximumSuppressionFilter

#if TARGET_IPHONE_SIMULATOR || TARGET_OS_IPHONE
NSString *const kECImageDirectionalNonmaximumSuppressionFragmentShaderString = SHADER_STRING
(
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageDirectionalNonmaximumSuppressionFragmentShaderString]))
    {
        return nil;
    }
