...
@class ECImageSingleComponentGaussianBlurFilter;
@class ECImageDirectionalSobelEdgeDetectionFilter;
@class ECImageDirectionalNonMaximumSuppressionFilter;
@class ECImageWeakPixelInclusionFilter;
 ...
 */
@interface ECImageCannyEdgeDetectionFilter : ECImageFilterGroup
{
    ECImageGrayscaleFilter *luminanceFilter;
    ECImageSingleComponentGaussianBlurFilter *blurFilter;
    ECImageDirectionalSobelEdgeDetectionFilter *edgeDetectionFilter;
    ECImageDirectionalNonMaximumSuppressionFilter *nonMaximumSuppressionFilter;
    ECImageWeakPixelInclusionFilter *weakPixelInclusionFilter;
}
