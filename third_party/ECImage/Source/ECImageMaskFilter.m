...
NSString *const kECImageMaskShaderString = SHADER_STRING
(
...
@implementation ECImageMaskFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageMaskShaderString]))
    {
		return nil;
    }
