...
@implementation ECImageThresholdEdgeDetectionFilter

// Invert the colorspace for a sketch
#if TARGET_IPHONE_SIMULATOR || TARGET_OS_IPHONE
NSString *const kECImageThresholdEdgeDetectionFragmentShaderString = SHADER_STRING
(
...
- (id)init;
{
    if (!(self = [self initWithFragmentShaderFromString:kECImageThresholdEdgeDetectionFragmentShaderString]))
    {
		return nil;
    }
