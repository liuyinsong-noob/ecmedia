...
NSString *const kECImageCropFragmentShaderString =  SHADER_STRING
(
...
@implementation ECImageCropFilter
...
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageCropFragmentShaderString]))
    {
        return nil;
    }
...
- (void)calculateCropTextureCoordinates;
{
    ...
    switch(inputRotation)
    {
        ...
        case kECImageRotateRight: // Fixed
        {
        ...
        case kECImageFlipVertical: // Works for me
        {
        ...
        case kECImageFlipHorizonal: // Works for me
        {
        ...
        case kECImageRotateRightFlipVertical: // Fixed
        {
        ...
        case kECImageRotateRightFlipHorizontal: // Fixed
        {
