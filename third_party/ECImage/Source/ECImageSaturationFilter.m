...
NSString *const kECImageSaturationFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageSaturationFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageSaturationFragmentShaderString]))
    {
		return nil;
    }
