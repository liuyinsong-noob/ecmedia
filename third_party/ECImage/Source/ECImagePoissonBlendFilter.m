...
NSString *const kECImagePoissonBlendFragmentShaderString = SHADER_STRING
(
...
@implementation ECImagePoissonBlendFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImagePoissonBlendFragmentShaderString]))
    {
		return nil;
    }
...
- (void)renderToTextureWithVertices:(const GLfloat *)vertices textureCoordinates:(const GLfloat *)textureCoordinates;
{
    ...
    for (int pass = 1; pass < self.numIterations; pass++) {
        ...
        if (pass % 2 == 0) {
            ...
            [super renderToTextureWithVertices:vertices textureCoordinates:[[self class] textureCoordinatesForRotation:kECImageNoRotation]];
        } else {
            ...
            glVertexAttribPointer(filterTextureCoordinateAttribute, 2, GL_FLOAT, 0, 0, [[self class] textureCoordinatesForRotation:kECImageNoRotation]);
