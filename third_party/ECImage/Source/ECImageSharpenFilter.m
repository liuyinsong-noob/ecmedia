...
NSString *const kECImageSharpenVertexShaderString = SHADER_STRING
(
...
NSString *const kECImageSharpenFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageSharpenFilter
...
- (id)init;
{
    if (!(self = [super initWithVertexShaderFromString:kECImageSharpenVertexShaderString fragmentShaderFromString:kECImageSharpenFragmentShaderString]))
    {
		return nil;
    }
