...
@interface ECImageFramebufferCache()
{
...
@implementation ECImageFramebufferCache
...
//    framebufferCache = [[NSCache alloc] init];
    ...
    framebufferCacheQueue = dispatch_queue_create("com.sunsetlakesoftware.ECImage.framebufferCacheQueue", NULL);
...
#if TARGET_IPHONE_SIMULATOR || TARGET_OS_IPHONE
        CVOpenGLESTextureCacheFlush([[ECImageContext sharedImageProcessingContext] coreVideoTextureCache], 0);
#else
#endif
    });
}
