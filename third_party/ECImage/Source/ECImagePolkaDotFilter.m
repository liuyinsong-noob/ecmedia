...
NSString *const kECImagePolkaDotFragmentShaderString = SHADER_STRING
(
...
@implementation ECImagePolkaDotFilter

@synthesize dotScaling = _dotScaling;

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImagePolkaDotFragmentShaderString]))
    {
		return nil;
    }
