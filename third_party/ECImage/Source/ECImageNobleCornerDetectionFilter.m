...
@implementation ECImageNobleCornerDetectionFilter

#if TARGET_IPHONE_SIMULATOR || TARGET_OS_IPHONE
NSString *const kECImageNobleCornerDetectionFragmentShaderString = SHADER_STRING
( 
...
- (id)init;
{
    if (!(self = [self initWithCornerDetectionFragmentShader:kECImageNobleCornerDetectionFragmentShaderString]))
    {
        return nil;
    }
