...
NSString *const kECImageLevelsFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageLevelsFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageLevelsFragmentShaderString]))
    {
		return nil;
    }
