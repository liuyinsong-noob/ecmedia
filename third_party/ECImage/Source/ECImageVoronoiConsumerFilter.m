...
NSString *const kECImageVoronoiConsumerFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageVoronoiConsumerFilter

@synthesize sizeInPixels = _sizeInPixels;

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageVoronoiConsumerFragmentShaderString]))
    {
		return nil;
    }
