...
NSString *const kECImageChromaKeyFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageChromaKeyFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageChromaKeyFragmentShaderString]))
    {
		return nil;
    }
