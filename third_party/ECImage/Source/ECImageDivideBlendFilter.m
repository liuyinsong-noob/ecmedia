...
NSString *const kECImageDivideBlendFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageDivideBlendFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageDivideBlendFragmentShaderString]))
    {
		return nil;
    }
