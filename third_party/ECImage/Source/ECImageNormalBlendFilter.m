...
NSString *const kECImageNormalBlendFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageNormalBlendFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageNormalBlendFragmentShaderString]))
    {
		return nil;
    }
