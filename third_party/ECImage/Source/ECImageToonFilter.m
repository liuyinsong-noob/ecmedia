...
NSString *const kECImageToonFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageToonFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageToonFragmentShaderString]))
    {
		return nil;
    }
