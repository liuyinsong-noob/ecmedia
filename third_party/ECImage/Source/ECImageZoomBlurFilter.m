...
NSString *const kECImageZoomBlurFragmentShaderString = SHADER_STRING
(
...
@interface ECImageZoomBlurFilter()
{
    GLint blurSizeUniform, blurCenterUniform;
}
@end

@implementation ECImageZoomBlurFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageZoomBlurFragmentShaderString]))
    {
        return nil;
    }
