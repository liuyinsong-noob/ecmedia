...
NSString *const kECImageSobelEdgeDetectionFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageSobelEdgeDetectionFilter
...
- (id)init;
{
    if (!(self = [self initWithFragmentShaderFromString:kECImageSobelEdgeDetectionFragmentShaderString]))
    {
		return nil;
    }
...
- (id)initWithFragmentShaderFromString:(NSString *)fragmentShaderString;
{
    ...
    if (!(self = [super initWithFirstStageVertexShaderFromString:kECImageVertexShaderString firstStageFragmentShaderFromString:kECImageLuminanceFragmentShaderString secondStageVertexShaderFromString:kECImageNearbyTexelSamplingVertexShaderString secondStageFragmentShaderFromString:fragmentShaderString]))
    {
		return nil;
    }
...
- (void)setupFilterForSize:(CGSize)filterFrameSize;
{
    if (!hasOverriddenImageSizeFactor)
    {
        ...
        runSynchronouslyOnVideoProcessingQueue(^{
            ...
            [ECImageContext setActiveShaderProgram:previousProgram];
        });
    }
}
