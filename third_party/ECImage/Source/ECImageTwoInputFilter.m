...
NSString *const kECImageTwoInputTextureVertexShaderString = SHADER_STRING
(
...
@implementation ECImageTwoInputFilter
...
{
    if (!(self = [self initWithVertexShaderFromString:kECImageTwoInputTextureVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
		return nil;
    }
...
- (id)initWithVertexShaderFromString:(NSString *)vertexShaderString fragmentShaderFromString:(NSString *)fragmentShaderString;
{
    ...
    inputRotation2 = kECImageNoRotation;
