...
extern NSString *const kECImageYUVVideoRangeConversionForRGFragmentShaderString;
extern NSString *const kECImageYUVFullRangeConversionForLAFragmentShaderString;
extern NSString *const kECImageYUVVideoRangeConversionForLAFragmentShaderString;


//Delegate Protocal for Face Detection.
@protocol ECImageVideoCameraDelegate <NSObject>
...
/**
 A ECImageOutput that provides frames from either camera
*/
@interface ECImageVideoCamera : ECImageOutput <AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureAudioDataOutputSampleBufferDelegate>
{
    ...
    BOOL capturePaused;
    ECImageRotationMode outputRotation, internalRotation;
    dispatch_semaphore_t frameRenderingSemaphore;
        
    BOOL captureAsYUV;
    GLuint luminanceTexture, chrominanceTexture;

    __unsafe_unretained id<ECImageVideoCameraDelegate> _delegate;
}
...
@property(nonatomic, assign) id<ECImageVideoCameraDelegate> delegate;
