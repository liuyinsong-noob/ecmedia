...
NSString *const kECImageHueFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageHueFilter
@synthesize hue;

- (id)init
{
    if(! (self = [super initWithFragmentShaderFromString:kECImageHueFragmentShaderString]) )
    {
        return nil;
    }
