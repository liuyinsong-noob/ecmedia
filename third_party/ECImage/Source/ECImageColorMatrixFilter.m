...
NSString *const kECImageColorMatrixFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageColorMatrixFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageColorMatrixFragmentShaderString]))
    {
        return nil;
    }
