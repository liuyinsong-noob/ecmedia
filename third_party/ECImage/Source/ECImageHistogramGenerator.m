...
NSString *const kECImageHistogramGeneratorVertexShaderString = SHADER_STRING
(
...
NSString *const kECImageHistogramGeneratorFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageHistogramGenerator
...
- (id)init;
{
    if (!(self = [super initWithVertexShaderFromString:kECImageHistogramGeneratorVertexShaderString fragmentShaderFromString:kECImageHistogramGeneratorFragmentShaderString]))
    {
        return nil;
    }
