...
NSString *const kECImageUnsharpMaskFragmentShaderString = SHADER_STRING
( 
...
@implementation ECImageUnsharpMaskFilter
...
- (id)init;
{
    ...
    unsharpMaskFilter = [[ECImageTwoInputFilter alloc] initWithFragmentShaderFromString:kECImageUnsharpMaskFragmentShaderString];
