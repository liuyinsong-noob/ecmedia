...
NSString *const kECImageWhiteBalanceFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageWhiteBalanceFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageWhiteBalanceFragmentShaderString]))
    {
		return nil;
    }
