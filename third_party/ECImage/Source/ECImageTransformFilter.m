...
NSString *const kECImageTransformVertexShaderString = SHADER_STRING
(
...
@implementation ECImageTransformFilter
...
- (id)init;
{
    if (!(self = [super initWithVertexShaderFromString:kECImageTransformVertexShaderString fragmentShaderFromString:kECImagePassthroughFragmentShaderString]))
    {
        return nil;
    }
