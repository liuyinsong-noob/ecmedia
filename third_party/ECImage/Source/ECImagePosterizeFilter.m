...
NSString *const kECImagePosterizeFragmentShaderString = SHADER_STRING
( 
...
@implementation ECImagePosterizeFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImagePosterizeFragmentShaderString]))
    {
		return nil;
    }
