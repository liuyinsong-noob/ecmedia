...
NSString *const kECImageHalftoneFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageHalftoneFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageHalftoneFragmentShaderString]))
    {
		return nil;
    }
