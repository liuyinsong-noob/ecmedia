...
NSString *const kECImageHueBlendFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageHueBlendFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageHueBlendFragmentShaderString]))
    {
		return nil;
    }
