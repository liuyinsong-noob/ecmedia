...
NSString *const kECImageHazeFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageHazeFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageHazeFragmentShaderString]))
    {
		return nil;
    }
