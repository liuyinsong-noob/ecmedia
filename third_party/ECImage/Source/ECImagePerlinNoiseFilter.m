...
NSString *const kECImagePerlinNoiseFragmentShaderString = SHADER_STRING
(
...
@implementation ECImagePerlinNoiseFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImagePerlinNoiseFragmentShaderString]))
    {
		return nil;
    }
