...
NSString *const kECImageStretchDistortionFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageStretchDistortionFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageStretchDistortionFragmentShaderString]))
    {
		return nil;
    }
