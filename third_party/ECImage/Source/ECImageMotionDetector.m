...
NSString *const kECImageMotionComparisonFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageMotionDetector
...
- (id)init;
{
    ...
    frameComparisonFilter = [[ECImageTwoInputFilter alloc] initWithFragmentShaderFromString:kECImageMotionComparisonFragmentShaderString];
    ...
    averageColor = [[ECImageAverageColor alloc] init];
    
    __unsafe_unretained ECImageMotionDetector *weakSelf = self;
