...
NSString *const kECImageHighlightShadowFragmentShaderString = SHADER_STRING
(
...
@implementation ECImageHighlightShadowFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageHighlightShadowFragmentShaderString]))
    {
		return nil;
    }
