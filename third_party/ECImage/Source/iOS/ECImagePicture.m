...
- (id)initWithCGImage:(CGImageRef)newImageSource smoothlyScaleOutput:(BOOL)smoothlyScaleOutput;
{
    ...
    CGSize scaledImageSizeToFitOnGPU = [ECImageContext sizeThatFitsWithinATextureForSize:pixelSizeOfImage];
...
- (void)processImageUpToFilter:(ECImageOutput<ECImageInput> *)finalFilterInChain withCompletionHandler:(void (^)(UIImage *processedImage))block;
{
