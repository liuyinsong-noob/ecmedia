...
@implementation ECImageShiTomasiFeatureDetectionFilter

#if TARGET_IPHONE_SIMULATOR || TARGET_OS_IPHONE
NSString *const kECImageShiTomasiCornerDetectionFragmentShaderString = SHADER_STRING
( 
...
- (id)init;
{
    if (!(self = [self initWithCornerDetectionFragmentShader:kECImageShiTomasiCornerDetectionFragmentShaderString]))
    {
        return nil;
    }
