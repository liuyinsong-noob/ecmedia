...
NSString *const kECImageNearbyTexelSamplingVertexShaderString = SHADER_STRING
(
...
@implementation ECImage3x3TextureSamplingFilter
...
{
    if (!(self = [self initWithVertexShaderFromString:kECImageNearbyTexelSamplingVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
        return nil;
    }
