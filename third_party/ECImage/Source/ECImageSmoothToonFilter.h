...
@class ECImageToonFilter;

/** This uses a similar process as the ECImageToonFilter, only it precedes the toon effect with a Gaussian blur to smooth out noise.
 */
@interface ECImageSmoothToonFilter : ECImageFilterGroup
{
    ECImageGaussianBlurFilter *blurFilter;
    ECImageToonFilter *toonFilter;
}
