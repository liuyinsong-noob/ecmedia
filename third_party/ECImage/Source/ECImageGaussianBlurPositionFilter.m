...
NSString *const kECImageGaussianBlurPositionVertexShaderString = SHADER_STRING
(
...
NSString *const kECImageGaussianBlurPositionFragmentShaderString = SHADER_STRING
(
...
@interface ECImageGaussianBlurPositionFilter ()
...
@implementation ECImageGaussianBlurPositionFilter
...
- (id) initWithFirstStageVertexShaderFromString:(NSString *)firstStageVertexShaderString 
    ...
    if (!(self = [super initWithFirstStageVertexShaderFromString:firstStageVertexShaderString ? firstStageVertexShaderString : kECImageGaussianBlurPositionVertexShaderString
                              firstStageFragmentShaderFromString:firstStageFragmentShaderString ? firstStageFragmentShaderString : kECImageGaussianBlurPositionFragmentShaderString
                               secondStageVertexShaderFromString:secondStageVertexShaderString ? secondStageVertexShaderString : kECImageGaussianBlurPositionVertexShaderString
                             secondStageFragmentShaderFromString:secondStageFragmentShaderString ? secondStageFragmentShaderString : kECImageGaussianBlurPositionFragmentShaderString])) {
        return nil;
    }
