...
@implementation ECImageUIElement
...
//    CGContextRotateCTM(imageContext, M_PI_2);
    ...
    outputFramebuffer = [[ECImageContext sharedFramebufferCache] fetchFramebufferForSize:layerPixelSize textureOptions:self.outputTextureOptions onlyTexture:YES];
