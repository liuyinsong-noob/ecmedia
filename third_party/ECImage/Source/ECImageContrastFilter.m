...
NSString *const kECImageContrastFragmentShaderString = SHADER_STRING
( 
...
@implementation ECImageContrastFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kECImageContrastFragmentShaderString]))
    {
		return nil;
    }
