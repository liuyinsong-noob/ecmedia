...
.set cospi_1_64  ,  16364
.set cospi_2_64  ,  16305
.set cospi_3_64  ,  16207
.set cospi_4_64  ,  16069
.set cospi_5_64  ,  15893
.set cospi_6_64  ,  15679
.set cospi_7_64  ,  15426
.set cospi_8_64  ,  15137
.set cospi_9_64  ,  14811
.set cospi_10_64 ,  14449
.set cospi_11_64 ,  14053
.set cospi_12_64 ,  13623
.set cospi_13_64 ,  13160
.set cospi_14_64 ,  12665
.set cospi_15_64 ,  12140
.set cospi_16_64 ,  11585
.set cospi_17_64 ,  11003
.set cospi_18_64 ,  10394
.set cospi_19_64 ,   9760
.set cospi_20_64 ,   9102
.set cospi_21_64 ,   8423
.set cospi_22_64 ,   7723
.set cospi_23_64 ,   7005
.set cospi_24_64 ,   6270
.set cospi_25_64 ,   5520
.set cospi_26_64 ,   4756
.set cospi_27_64 ,   3981
.set cospi_28_64 ,   3196
.set cospi_29_64 ,   2404
.set cospi_30_64 ,   1606
.set cospi_31_64 ,    804


    .globl _vpx_idct32x32_1024_add_neon
	.globl vpx_idct32x32_1024_add_neon
   @ ARM
   @ 
   @ PRESERVE8
...
.macro LOAD_FROM_TRANSPOSED
    ...
    .endm
     ...
     @   use.
.macro LOAD_FROM_OUTPUT
     @ address calculation with proper stride and loading
    add r1, #($1  - $0 )*32*2
    vld1.s16        {$3}, [r1]
    add r1, #($2 - $1)*32*2
    vld1.s16        {$4}, [r1]
     @ (used) two registers ($3, $4)
    .endm
     @ --------------------------------------------------------------------------
...
.macro DO_BUTTERFLY
    ...
    vqrshrn.s32 $6, q8,  #14
    vqrshrn.s32 $7, q9,  #14
    vqrshrn.s32 $8, q11, #14
    vqrshrn.s32 $9, q10, #14
     @ (used) two for results, well four d registers
    .endm
     @ --------------------------------------------------------------------------
     @ Touches q8-q12, q15 (q13-q14 are preserved)
     @ valid output registers are anything but q8-q11
.macro DO_BUTTERFLY_STD
    DO_BUTTERFLY d28, d29, d26, d27, $0, $1, $2, $3, $4, $5
    .endm
     @ --------------------------------------------------------------------------
