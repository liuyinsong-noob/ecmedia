...
@  using the ads2gas_apple.pl script.
 ...
 @
    ...
    .globl _vpx_idct16x16_256_add_neon_pass1
	.globl vpx_idct16x16_256_add_neon_pass1
    .globl _vpx_idct16x16_256_add_neon_pass2
	.globl vpx_idct16x16_256_add_neon_pass2
    .globl _vpx_idct16x16_10_add_neon_pass1
	.globl vpx_idct16x16_10_add_neon_pass1
    .globl _vpx_idct16x16_10_add_neon_pass2
	.globl vpx_idct16x16_10_add_neon_pass2
   @ ARM
   @ 
   @ PRESERVE8
...
_vpx_idct16x16_256_add_neon_pass1:
 ...
 @ will be stored back into q8-q15 registers. This function will touch q0-q7
 @ registers and use them as buffer during calculation.
_vpx_idct16x16_256_add_neon_pass2:
...
end_idct16x16_pass2:
 ...
 @ will be stored back into q8-q15 registers. This function will touch q0-q7
 @ registers and use them as buffer during calculation.
_vpx_idct16x16_10_add_neon_pass1:
 ...
 @ will be stored back into q8-q15 registers. This function will touch q0-q7
 @ registers and use them as buffer during calculation.
_vpx_idct16x16_10_add_neon_pass2:
