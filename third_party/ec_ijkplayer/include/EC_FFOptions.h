...
typedef enum EC_FFOptionCategory {
    kECFFOptionCategoryFormat = 1,
    kECFFOptionCategoryCodec  = 2,
    kECFFOptionCategorySws    = 3,
    kECFFOptionCategoryPlayer = 4,
    kECFFOptionCategorySwr    = 5,
} ECFFOptionCategory;
...
@interface EC_FFOptions : NSObject

+(EC_FFOptions *)optionsByDefault;
