...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=x86_64 --cc='xcrun -sdk iphonesimulator clang' --disable-everything --enable-cross-compile --disable-debug --disable-programs --disable-doc --enable-pic --disable-iconv --enable-videotoolbox --enable-hwaccel=h264_videotoolbox --enable-decoder=h264 --enable-hwaccel=h264_videotoolbox --enable-gpl --enable-libx264 --extra-cflags='-arch x86_64 -mios-simulator-version-min=8.0 -I/Users/yukening/Downloads/ecmedia/third_party/ffmpeg_4.2.1/fat-x264/include' --extra-ldflags='-arch x86_64 -mios-simulator-version-min=8.0 -L/Users/yukening/Downloads/ecmedia/third_party/ffmpeg_4.2.1/fat-x264/lib' --prefix=/Users/yukening/Downloads/ecmedia/third_party/ffmpeg_4.2.1/thin/x86_64
...
CC_IDENT=Apple clang version 11.0.0 (clang-1100.0.33.12)
ARCH=x86
INTRINSICS=none
EXTERN_PREFIX=_
...
CFLAGS=  -arch x86_64 -mios-simulator-version-min=8.0 -I/Users/yukening/Downloads/ecmedia/third_party/ffmpeg_4.2.1/fat-x264/include -std=c11 -Werror=partial-availability -fomit-frame-pointer -fPIC -pthread  -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -arch x86_64 -mios-simulator-version-min=8.0 -I/Users/yukening/Downloads/ecmedia/third_party/ffmpeg_4.2.1/fat-x264/include -fPIC -Qunused-arguments
...
DOXYGEN=doxygen
LDFLAGS= -arch x86_64 -mios-simulator-version-min=8.0 -L/Users/yukening/Downloads/ecmedia/third_party/ffmpeg_4.2.1/fat-x264/lib  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-avcodec=-pthread -lm -framework VideoToolbox -framework CoreFoundation -framework CoreMedia -framework CoreVideo
