...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=i386 --cc='xcrun -sdk iphonesimulator clang' --disable-everything --enable-cross-compile --disable-debug --disable-programs --disable-doc --enable-pic --disable-iconv --enable-videotoolbox --enable-hwaccel=h264_videotoolbox --enable-decoder=h264 --enable-hwaccel=h264_videotoolbox --enable-gpl --enable-libx264 --extra-cflags='-arch i386 -mios-simulator-version-min=8.0 -I/Users/yukening/Downloads/ecmedia/third_party/ffmpeg_4.2.1/fat-x264/include' --extra-ldflags='-arch i386 -mios-simulator-version-min=8.0 -L/Users/yukening/Downloads/ecmedia/third_party/ffmpeg_4.2.1/fat-x264/lib' --prefix=/Users/yukening/Downloads/ecmedia/third_party/ffmpeg_4.2.1/thin/i386
prefix=/Users/yukening/Downloads/ecmedia/third_party/ffmpeg_4.2.1/thin/i386
...
OBJCFLAGS=  
ASFLAGS=  -arch i386 -mios-simulator-version-min=8.0 -I/Users/yukening/Downloads/ecmedia/third_party/ffmpeg_4.2.1/fat-x264/include -fPIC -Qunused-arguments
...
DOXYGEN=doxygen
LDFLAGS= -arch i386 -mios-simulator-version-min=8.0 -L/Users/yukening/Downloads/ecmedia/third_party/ffmpeg_4.2.1/fat-x264/lib  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
