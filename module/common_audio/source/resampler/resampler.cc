...
//Sean add begin 20131121 noise suppression
int Resampler::SetModeForNoiseSupprion()
{
	my_type_ = kResamplerSynchronous;
	my_mode_ = kResamplerModeNoise;
	return 0;
}
//Sean add end 20131121 noise suppression
}  // namespace webrtc
