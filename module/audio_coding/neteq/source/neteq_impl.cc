...
#if 1
          if (neteq_debug) {
              debug_file_ = fopen(neteq_debug, "wb+");
          }
#endif
}
...
//        printf("sean haha kDtmf\n");
    ...
    case kAlternativePlc: {
        //没有�?//        printf("sean haha kAlternativePlc\n");
      // TODO(hlundin): Write test for this.
      DoAlternativePlc(false);
      break;
    }
    case kAlternativePlcIncreaseTimestamp: {
        //没有�?//        printf("sean haha kAlternativePlcIncreaseTimestamp\n");
      // TODO(hlundin): Write test for this.
      DoAlternativePlc(true);
      break;
    }
    case kAudioRepetitionIncreaseTimestamp: {
        //没有�?//        printf("sean haha kAudioRepetitionIncreaseTimestamp\n");
      // TODO(hlundin): Write test for this.
    ...
    case kAudioRepetition: {
        //没有�?//        printf("sean haha kAudioRepetition\n");
      // TODO(hlundin): Write test for this.
...
//  assert(sync_buffer_->FutureLength() >= expand_->overlap_length());//sean just for mos
...
//    if( !bAlreadyPlay && packet_buffer_->NumPacketsInBuffer() <5 ) {
//        *operation =kExpand;
//        return 0;
//    }
//    bAlreadyPlay = true;
