...
# endif
  ...
  {111, "SILK", 8000, 480, 1, 15000},
  {112, "SILK", 12000, 240, 1, 20000},
  {113, "SILK", 16000, 320, 1, 20000},
#endif
#ifdef WEBRTC_CODEC_GSMFR
  ...
  // Mono and stereo.
  {121, "opus", 8000, 160, 1, 24000},
  {122, "opus", 16000, 320, 1, 44000},
  {124, "opus", 48000, 960, 1, 64000},
#endif
#ifdef WEBRTC_CODEC_SPEEX
...
#ifdef WEBRTC_CODEC_SILK
	{5, {160, 320, 480, 640, 800}, 0, 1},
	{5, {240, 480, 720, 960, 1200}, 0, 1},
	{5, {320, 640, 960, 1280, 1600}, 0, 1},    
#endif
...
ACMGenericCodec* ACMCodecDB::CreateCodecInstance(const CodecInst& codec_inst) {
  ...
  if (!STR_CASE_CMP(codec_inst.plname, "ISAC")) {
    ...
    return new ACMG729_1(kG729_1);
#endif
  }else if (!STR_CASE_CMP(codec_inst.plname, "SILK")) {
#ifdef WEBRTC_CODEC_SILK      
	  int codec_id;
	  switch (codec_inst.plfreq) {
	  case 8000: {
	  ...
	  //return new ACMSILK(codec_id); //need fix, by ylr;
	  return NULL;
#endif
