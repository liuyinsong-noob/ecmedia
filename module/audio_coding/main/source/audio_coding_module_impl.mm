...
void AudioCodingModuleImpl::setupSoundTouch() {
    ...
    _soundTouch->setPitchSemiTones(8); //设置声音的pitch (集音高变化semi-tones相比原来的音调) //男: -8 女:8
...
//      if (!codec_ptr->HasInternalFEC() || !send_codec.fecEnabled) {
//        codec_fec_enabled_ = false;
//      } else {
...
//      if (send_codec.packetLossRate>0.000001 && !strcmp(send_codec.plname,"opus")) {
//          codec_ptr->SetPacketLossRate(send_codec.packetLossRate);
//      }
