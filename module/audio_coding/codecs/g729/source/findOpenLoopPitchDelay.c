...
uint16_t findOpenLoopPitchDelay(word16_t weightedInputSignal[])
{
	...
	word32_t autoCorrelationRange1,autoCorrelationRange2,autoCorrelationRange3;
	uint16_t indexRange1=0, indexRange2=0, indexRange3Even=0, indexRange3;
	word32_t correlationMaxRange1,correlationMaxRange2,correlationMaxRange3;
	word32_t normalisedCorrelationMaxRange1,normalisedCorrelationMaxRange2,normalisedCorrelationMaxRange3;
...
/*      correlation = ¡Æ(i=0..39)inputSignal[2*i]*inputSignal[2*i-index]      */
/*    paremeters:                                                            */
