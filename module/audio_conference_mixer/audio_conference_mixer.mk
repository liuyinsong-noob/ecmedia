...
INCS_Release :=-I../../.  \
	...
	-I./include \
	-I../audioprocess/include \
	-I../utility/include \
	-I../audio_coding/main/include 

OBJS := $(OUTPUT)/audio_frame_manipulator.o \
	$(OUTPUT)/level_indicator.o \
	$(OUTPUT)/audio_conference_mixer_impl.o \
	$(OUTPUT)/time_scheduler.o

$(MYLIB)/libaudio_conference_mixer.a:$(OBJS)
	mkdir -p $(MYLIB)
	 $(AR) $(ARFLAGS) $@ $(OBJS)
