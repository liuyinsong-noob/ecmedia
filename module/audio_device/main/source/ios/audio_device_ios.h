...
const WebRtc_UWord32 N_REC_SAMPLES_PER_SEC_6s = 48000;
const WebRtc_UWord32 N_PLAY_SAMPLES_PER_SEC_6s = 48000;

const WebRtc_UWord32 ENGINE_REC_BUF_SIZE_IN_SAMPLES_6s = (N_REC_SAMPLES_PER_SEC_6s
                                                          / 100);
const WebRtc_UWord32 ENGINE_PLAY_BUF_SIZE_IN_SAMPLES_6s = (N_PLAY_SAMPLES_PER_SEC_6s
                                                           / 100);
