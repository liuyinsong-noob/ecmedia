...
#define VCM_H264_HIGH_IDX (VCM_H264_IDX + 1)
#else
#define VCM_H264_HIGH_IDX VCM_H264_IDX
#endif
#ifdef VIDEOCODEC_I420
  #define VCM_I420_IDX (VCM_H264_HIGH_IDX + 1)
#else
  #define VCM_I420_IDX VCM_H264_HIGH_IDX
#endif
