...
{
    WEBRTC_TRACE(cloopenwebrtc::kTraceDebug,cloopenwebrtc::kTraceVideoCoding,0,"H264Decoder::Decode width %d, height %d, lowseq %u, highseq %u", inputImage._encodedWidth, inputImage._encodedHeight, inputImage._lowSeqNum, inputImage._encodedHeight);
...
#ifndef FRAGMENT_DECODE
	{
		...
		{	
			...
			{
                WEBRTC_TRACE(cloopenwebrtc::kTraceDebug,cloopenwebrtc::kTraceVideoCoding,0,"H264Decoder::Decode succeed width %d, height %d, lowseq %u, highseq %u", inputImage._encodedWidth, inputImage._encodedHeight, inputImage._lowSeqNum, inputImage._encodedHeight);
				return ReturnFrame(pFrame_, inputImage._timeStamp, inputImage.ntp_time_ms_);
				
			}else
            {
                WEBRTC_TRACE(cloopenwebrtc::kTraceDebug,cloopenwebrtc::kTraceVideoCoding,0,"H264Decoder::Decode failed width %d, height %d, lowseq %u, highseq %u", inputImage._encodedWidth, inputImage._encodedHeight, inputImage._lowSeqNum, inputImage._encodedHeight);
				return WEBRTC_VIDEO_CODEC_ERROR;  //
            }
