...
class VideoFrameBuffer : public RefCountInterface {
 public:
  ...
  // native handle.
  virtual scoped_refptr<VideoFrameBuffer> NativeToI420Buffer() = 0;
...
class I420Buffer : public VideoFrameBuffer {
 public:
  ...
  scoped_refptr<VideoFrameBuffer> NativeToI420Buffer() override;

  // Create a new buffer and copy the pixel data.
  static scoped_refptr<I420Buffer> Copy(
...
class WrappedI420Buffer : public VideoFrameBuffer {
 public:
 ...
 private:
  ...
  const int u_stride_;
  const int v_stride_;
  Callback0<void> no_longer_used_cb_;
};
