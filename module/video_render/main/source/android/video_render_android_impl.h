...
class VideoRenderAndroid: IVideoRender {
 public:
  static WebRtc_Word32 SetAndroidEnvVariables(void* javaVM, void* env, void* context);
...
public:
    static jclass g_renderGLClass;
    static jclass g_renderSurfaceClass;
    static jobject g_classLoader;
    static jmethodID g_loadClassID;
