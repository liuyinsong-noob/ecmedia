...
//#import "gles_render_view.h"
#import "iosdisplay.h"
#import "opengles_display.h"
...
public:
    ...
    VideoChannelNSOpenGL(ECIOSDisplay *window, int iId, VideoRenderNSOpenGL* owner);
...
//    int IsUpdated(bool& isUpdated);
    ...
    int ChangeWindow(ECIOSDisplay *IOSDisplay);
...
public: // methods  //TODO
    VideoRenderNSOpenGL(UIView *windowRef, bool fullScreen, int iId);
    ~VideoRenderNSOpenGL();
...
//    bool IsFullScreen();
    ...
    // ********** new module functions ************ //  //TODO
    int ChangeWindow(UIView* newWindowRef);
