...
OBJS := $(OUTPUT)/incoming_video_stream.o \
	$(OUTPUT)/video_render_frames.o \
	$(OUTPUT)/video_render_impl.o \
	$(OUTPUT)/video_render_android_impl.o \
	$(OUTPUT)/video_render_android_native_opengl2.o \
	$(OUTPUT)/video_render_android_surface_view.o \
	$(OUTPUT)/video_render_opengles20.o \
	$(OUTPUT)/video_render_external_impl.o

$(MYLIB)/libvideo_render_module.a:$(OBJS)
	mkdir -p $(MYLIB)
	 $(AR) $(ARFLAGS) $@ $(OBJS)
