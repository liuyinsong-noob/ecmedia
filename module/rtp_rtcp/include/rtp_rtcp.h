...
class RtpRtcp : public Module {
 public:
  struct Configuration {
	...
	RtcpPacketTypeCounterObserver* receive_rtcp_packettype_count_observer = nullptr;
  };
  ...
  virtual size_t MaxRtpPacketSize() const = 0;
     ...
     */
    virtual int32_t SetRTPKeepaliveStatus(const bool enable,
     ...
     *   return -1 on failure else 0
     */
    virtual int32_t RTPKeepaliveStatus(bool* enable,
