...
#include "../module/rtp_rtcp/source/rtp_receiver_impl.h"
...
#include "../module/rtp_rtcp/include/rtp_payload_registry.h"
...
RtpReceiver* RtpReceiver::CreateVideoReceiver(
  ...
  return new RtpReceiverImpl(
      id, clock, incoming_messages_callback, rtp_payload_registry,
