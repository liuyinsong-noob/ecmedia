...
void RtpReceiverImpl::PacketTimeout()
{
...
bool RtpReceiverImpl::IncomingRtpPacket(
  ...
  bool in_order) {
  //sean for mos test
//    int64_t current_receive_time = clock_->TimeInMilliseconds();
//    if (current_receive_time - last_receive_time_ > 100) {
//        last_receive_time_ = current_receive_time;
//        printf("sean haha drop %d\n",rtp_header.sequenceNumber);
//        return false;
//    }
//
    
    _lastReceiveTime = _clock->TimeInMilliseconds();
