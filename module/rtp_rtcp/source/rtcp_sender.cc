...
#include "../module/rtp_rtcp/source/rtcp_sender.h"
...
#include "../module/rtp_rtcp/source/rtcp_packet/app.h"
#include "../module/rtp_rtcp/source/rtcp_packet/bye.h"
#include "../module/rtp_rtcp/source/rtcp_packet/compound_packet.h"
#include "../module/rtp_rtcp/source/rtcp_packet/extended_reports.h"
#include "../module/rtp_rtcp/source/rtcp_packet/fir.h"
#include "../module/rtp_rtcp/source/rtcp_packet/nack.h"
#include "../module/rtp_rtcp/source/rtcp_packet/pli.h"
#include "../module/rtp_rtcp/source/rtcp_packet/receiver_report.h"
#include "../module/rtp_rtcp/source/rtcp_packet/remb.h"
#include "../module/rtp_rtcp/source/rtcp_packet/rpsi.h"
#include "../module/rtp_rtcp/source/rtcp_packet/sdes.h"
#include "../module/rtp_rtcp/source/rtcp_packet/sender_report.h"
#include "../module/rtp_rtcp/source/rtcp_packet/sli.h"
#include "../module/rtp_rtcp/source/rtcp_packet/tmmbn.h"
#include "../module/rtp_rtcp/source/rtcp_packet/tmmbr.h"
#include "../module/rtp_rtcp/source/rtcp_packet/transport_feedback.h"
#include "../module/rtp_rtcp/source/rtp_rtcp_impl.h"
...
class PacketContainer : public rtcp::CompoundPacket,
 ...
 public:
  ...
  size_t SendPackets(size_t max_payload_length) {
    DCHECK_LE(max_payload_length, IP_PACKET_SIZE);
...
std::unique_ptr<rtcp::RtcpPacket> RTCPSender::BuildSR(const RtcpContext& ctx) {
  ...
  DCHECK_GE(last_frame_capture_time_ms_, 0);
...
std::unique_ptr<rtcp::RtcpPacket> RTCPSender::BuildSDES(
  ...
  CHECK_LT(length_cname, RTCP_CNAME_SIZE);
...
bool RTCPSender::AddReportBlock(const FeedbackState& feedback_state,
  ...
  DCHECK(report_blocks_.find(ssrc) == report_blocks_.end());
...
bool RTCPSender::SendFeedbackPacket(const rtcp::TransportFeedback& packet) {
  ...
  DCHECK_LE(max_packet_size, IP_PACKET_SIZE);
  uint8_t buffer[IP_PACKET_SIZE];
