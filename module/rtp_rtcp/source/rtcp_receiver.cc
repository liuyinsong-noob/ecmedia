...
#include "../module/rtp_rtcp/source/rtcp_receiver.h"
...
#include "../module/rtp_rtcp/source/rtcp_packet/common_header.h"
...
#include "../module/rtp_rtcp/source/rtcp_packet/rapid_resync_request.h"
...
RTCPReceiver::RTCPReceiver(
    ...
    : clock_(clock),
      ...
      receive_frame_count_observer_(NULL),
      main_ssrc_(0),
      remote_ssrc_(0),
...
bool RTCPReceiver::ParseCompoundPacket(const uint8_t* packet_begin,
  ...
  for (const uint8_t* next_block = packet_begin; next_block != packet_end;
    ...
    DCHECK_GT(remaining_blocks_size, 0);
