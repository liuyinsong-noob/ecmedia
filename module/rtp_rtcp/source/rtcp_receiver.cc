...
void RTCPReceiver::HandleReportBlock(
  ...
  // Filter out all report blocks that are not for us.     //For the time being, don't check it
...
//      printf("sean haha main_ssrc_ %ld, rtcpPacket.FIRItem.SSRC %ld\n",main_ssrc_, rtcpPacket.FIRItem.SSRC);
//    return;
//  }
