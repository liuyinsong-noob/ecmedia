...
#include "../module/rtp_rtcp/source/packet_loss_stats.h"
...
class ModuleRtpRtcpImpl : public RtpRtcp, public RTCPReceiver::ModuleRtpRtcp {
 public:
  ...
  WebRtc_Word32 SetRTPKeepaliveStatus(const bool enable,
                                                const WebRtc_Word8 unknownPayloadType,
                                                const WebRtc_UWord16 deltaTransmitTimeMS) override;
    
  WebRtc_Word32 RTPKeepaliveStatus(bool* enable,
                                             WebRtc_Word8* unknownPayloadType,
                                             WebRtc_UWord16* deltaTransmitTimeMS) const override;
    
  bool RTPKeepalive() const override;
  ...
  void SetSendRtcpPacketTypeCountObserver(
