...
OBJS := $(OUTPUT)/brighten.o \
	$(OUTPUT)/brightness_detection.o \
	$(OUTPUT)/color_enhancement.o \
	$(OUTPUT)/content_analysis.o \
	$(OUTPUT)/deflickering.o \
	$(OUTPUT)/denoising.o \
	$(OUTPUT)/frame_preprocessor.o \
	$(OUTPUT)/spatial_resampler.o \
	$(OUTPUT)/video_decimator.o \
	$(OUTPUT)/video_processing_impl.o

$(MYLIB)/libvideo_processing.a:$(OBJS)
	mkdir -p $(MYLIB)
	 $(AR) $(ARFLAGS) $@ $(OBJS)
