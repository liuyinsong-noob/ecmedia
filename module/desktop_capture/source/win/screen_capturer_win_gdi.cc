...
bool ScreenCapturerWinGdi::GetShareCaptureRect(int &width, int &height)
{
    DesktopRect screen_rect = GetScreenRect(current_screen_id_, current_device_key_);
...
void ScreenCapturerWinGdi::Start(Callback* callback) {
  ...
  //if (composition_func_)
  //  (*composition_func_)(DWM_EC_DISABLECOMPOSITION); //note by qiuyu 20150923
}
