...
{
    kCapture_Ok = 0,
    kCapture_Window_Overlapped,
    kCapture_Window_IsIconic,
    kCapture_Window_Closed,
    kCapture_Window_Hidden,
    kCapture_NoCaptureImage
};
 ...
 public:
  ...
  class Callback {
   public:
    ...
    virtual void OnCaptureCompleted(DesktopFrame* frame, CaptureErrCode errCode = kCapture_Ok, DesktopRect *window_rect = NULL) = 0;
