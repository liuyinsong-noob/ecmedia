...
//                                      const WebRtc_Word32 id, const char* deviceUniqueIdUTF8);
	...
	virtual int32_t CaptureSettings(VideoCaptureCapability& settings){return -1;};
	virtual int32_t SetCaptureSettings(VideoCaptureCapability settings){return -1;};
    VideoCaptureEncodeInterface* GetEncodeInterface(const VideoCodec& /*codec*/)
    { return NULL; }
    virtual WebRtc_Word32 SetPreviewWindow(void*){
        return -1;
    }
...
private:
	...
	//---begin
	public:
		virtual WebRtc_Word32 StartSendImage(const I420VideoFrame& videoFrame,
			WebRtc_Word32 frameRate = 1);
		virtual WebRtc_Word32 StopSendImage();

		private:
			I420VideoFrame _startImage;
