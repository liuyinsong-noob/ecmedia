...
- (void)openDevice:(const char*) deviceId {
    ...
    AVCaptureDeviceFormat * newFormat = formatArr[7];
    //                newFormat.
...
//                NSLog(@"%@", [input.device.activeFormat videoSupportedFrameRateRanges]);
                
//                int count = 0;
//                NSArray *formatArr = input.device.formats;
////                for (id cursor in input.device.formats) {
////                    NSLog(@"cursor %@", cursor);
////                    NSLog(@"count %d", count++);
////                }
//                
...
//                NSError *error;
//                
//                NSLog(@"current format %@", newFormat);
////                newFormat.
