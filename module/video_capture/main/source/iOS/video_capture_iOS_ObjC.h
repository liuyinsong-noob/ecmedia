...
@interface VideoCaptureiOSObjC : NSObject <AVCaptureVideoDataOutputSampleBufferDelegate>{
//    BOOL                            _capturing;
//    int                             _counter;
//    int                             _frameRate;
//    int                             _frameWidth;
...
//@property (nonatomic, retain) UIView *localVideoWindow;
