...
namespace cloopenwebrtc
{
    ...
    namespace videocapturemodule
    {
                                                     ...
                                                     VideoCaptureCapability *settings)
		{
		    ...
		    RefCountImpl<VideoCaptureiOS>* implementation =
		    new RefCountImpl<VideoCaptureiOS>(id);
        ...
        VideoCaptureiOS::VideoCaptureiOS(const WebRtc_Word32 id) :
        VideoCaptureImpl(id),
        _captureDevice(NULL),
        _captureInfo(NULL),
        _isCapturing(false),
        ...
        VideoCaptureiOS::~VideoCaptureiOS()
        {
            ...
            if(_captureDevice)
            {
                _captureDevice->registerOwner((cloopenwebrtc::videocapturemodule::VideoCaptureiOS *)nil);
...
//                [_captureInfo release];
        ...
        WebRtc_Word32 VideoCaptureiOS::Init(
...
//            [_captureDevice stopCapture];
        ...
        WebRtc_Word32 VideoCaptureiOS::CaptureSettings(VideoCaptureCapability& settings)
        {
        ...
        WebRtc_Word32 VideoCaptureiOS::SetPreviewWindow(void* window)
        {            
...
#ifdef __APPLE_CC__
        WebRtc_Word32 VideoCaptureiOS::SetCaptureRotation(VideoCaptureRotation rotation)
        {
