...
static void capture_queue_cleanup(void* p) {
	VideoCaptureiOSObjC *capture = (VideoCaptureiOSObjC *)p;
	[capture release];
}

@interface VideoCaptureiOSObjC (Private)
...
- (NSNumber *)registerOwner:(webrtc::videocapturemodule::VideoCaptureiOS *)owner
{
    if (!owner) {
