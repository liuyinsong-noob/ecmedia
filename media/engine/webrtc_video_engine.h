...
class WebRtcVideoChannel : public VideoMediaChannel, public webrtc::Transport {
 public:
  ...
  VideoSendParameters GetSendParameters();
  VideoRecvParameters GetRecvParameters();
  ...
  bool MuteStream(uint32_t ssrc, bool mute) override { return false; }
  ...
  bool SendKeyframe();
  bool SetRequestKeyframeCallback(const int channelId,
