...
#ifndef GENERAL_TRANSPORT_H_
#define GENERAL_TRANSPORT_H_
...
struct GeneralTransportDescription {
 public:
  ...
  GeneralTransportDescription(const GeneralTransportDescription& from);
  ~GeneralTransportDescription();

  GeneralTransportDescription& operator=(const GeneralTransportDescription& from);
...
//
// On Threading: GeneralTransport performs work solely on the network thread, and
// so its methods should only be called on the network thread.
class GeneralTransport : public sigslot::has_slots<>,
 ...
 public:
  ...
  webrtc::RTCError SetLocalGeneralTransportDescription(
  ...
  webrtc::RTCError SetRemoteGeneralTransportDescription(
      const GeneralTransportDescription& jsep_description,
      webrtc::SdpType type);
  ...
  const GeneralTransportDescription* local_description() const {
    RTC_DCHECK_RUN_ON(network_thread_);
    return local_description_.get();
  }

  const GeneralTransportDescription* remote_description() const {
    RTC_DCHECK_RUN_ON(network_thread_);
 ...
 private:
  ...
  std::unique_ptr<GeneralTransportDescription> local_description_
      RTC_GUARDED_BY(network_thread_);
  std::unique_ptr<GeneralTransportDescription> remote_description_
      RTC_GUARDED_BY(network_thread_);
  ...
  RTC_DISALLOW_COPY_AND_ASSIGN(GeneralTransport);
};
