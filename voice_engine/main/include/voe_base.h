...
public:
	...
	virtual int SetOldConferenceFlag(int channel, bool oldConf) = 0;//add by leixb for old conference
...
//---end
    ...
    virtual int setConferenceParticipantCallbackTimeInterVal(int channelid, int timeInterVal) = 0;
