...
enum ViEErrors {
  ...
  //ViEDesktopShare.
  kViEDesktopShareAlreadyConnected = 12900,  // ConnectDesktopShare - A DesktopShare capture has already been connected to this video channel.
  kViEDesktopShareDoesNotExist,              // No DesktopShare capture exist with the provided capture id or unique name.
  kViEDesktopShareInvalidChannelId,          // ConnectDesktopShareCapture, DisconnectDesktopShareCapture- No Channel exist with the provided channel id.
  kViEDesktopShareNotConnected,              // DisconnectDesktopShareCapture- No DesktopShareCapture is connected to the channel.
  kViEDesktopShareNotStarted,                // Stop- The DesktopShareCapture is not started.
  kViEDesktopShareAlreadyStarted,            // Start- The DesktopShareCapture is already started.
  kViEDesktopShareAlreadyAllocated,          // AllocateDesktopShareCapture The device is already allocated.
  kViEDesktopShareMaxNoDevicesAllocated,     // AllocateDesktopShareCapture Max number of devices already allocated.
  kViEDesktopShareObserverAlreadyRegistered,       // RegisterObserver- An observer is already registered. Need to deregister first.
  kViEDesktopShareObserverNotRegistered,     // DeregisterObserver- No observer is registered.
  kViEDesktopShareUnknownError,              // An unknown error has occurred. Check the log file.
  kViEDesktopShareMacQtkitNotSupported,      // QTKit handles the capture devices automatically. Thus querying capture capabilities is not supported.
