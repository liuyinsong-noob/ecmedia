...
///*seanmodify20130402*/
//typedef int (*ReturnVideoWidthHeight)(void *call,int width,int height, int channelid);
///*seanmodify*/
...
typedef int (*ReturnVideoWidthHeight)(int width,int height, int channelid);
...
class ViERender {
 public:
  ...
  virtual int AddRenderer(const int render_id,
                          ...
                          const float bottom,
						  /*seanmodify20130402*/
						  ReturnVideoWidthHeight return_video_width_height/*seanmodify*/) = 0;
