...
// ViEDesktopCapture
enum { kViEMaxDesktopCapture=10};
// ViECodec
enum { kViEMaxCodecWidth = 4096 };
enum { kViEMaxCodecHeight = 3072 };
enum { kViEMaxCodecFramerate = 60 };
enum { kViEMinCodecBitrate = 10 };

enum { kMaxVideoBitrate = 4000};
enum { kMinVideoBitrate = 100};
...
enum {
	...
	kViEDesktopIdBase = 0x2010,
	kViEDesktopIdMax = 0x20FF,
