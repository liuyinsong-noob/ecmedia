...
// This is a helper class used by CLOPHTTPRequest to handle inflating (decompressing) data in memory and on disk
...
@interface CLOPDataDecompressor : NSObject {
	BOOL streamReady;
	z_stream zStream;
}
