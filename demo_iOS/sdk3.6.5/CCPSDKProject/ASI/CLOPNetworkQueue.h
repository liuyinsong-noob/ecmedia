...
#import "CLOPHTTPRequestDelegate.h"
#import "CLOPProgressDelegate.h"

@interface CLOPNetworkQueue : NSOperationQueue <CLOPProgressDelegate, CLOPHTTPRequestDelegate, NSCopying> {
...
// All CLOPNetworkQueues are paused when created so that total size can be calculated before the queue starts
