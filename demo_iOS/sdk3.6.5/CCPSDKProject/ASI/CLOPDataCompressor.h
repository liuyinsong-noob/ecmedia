...
// This is a helper class used by CLOPHTTPRequest to handle deflating (compressing) data in memory and on disk
...
@interface CLOPDataCompressor : NSObject {
	BOOL streamReady;
	z_stream zStream;
}
