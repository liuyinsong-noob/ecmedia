 ...
 * 
 * Note that this method may be calledreadToData multiple times for a single read if you return positive numbers.
**/
 ...
 * 
 * The elapsed parameter is the sum of the original timeout, plus any additions previously added via this method.
 * The length parameter is the number of bytes that have beenwritten so far for the write operation.
 * 
