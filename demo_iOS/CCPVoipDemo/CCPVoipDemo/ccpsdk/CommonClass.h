...
@property (nonatomic, assign) NSInteger *count;//消息数量
@end
...
@property (nonatomic, retain) NSArray   *msgs;//离线消息数组InstanceMsg类型，使用需要判断类型是IMTextMsg还是IMAttachedMsg
@end

//确认离线消息
@interface ConfirmOfflineMsg : NSObject
@property (nonatomic, retain) NSString *msgId;//消息Id
@property (nonatomic, retain) NSString *type;//类型0文本，1文件
@end
