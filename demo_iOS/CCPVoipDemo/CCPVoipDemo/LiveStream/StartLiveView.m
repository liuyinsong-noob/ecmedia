...
- (void) startPlay:(id) sender {
    ...
    if(self.startPlayLiveButton.selected) {
        ...
        // play rtmp
        [self.modelEngineVoip playStream:self.session url:self.live_url_textView.text view:self.liveRenderView];
...
- (void) startPush:(id) sender {
    ...
    if(self.startPushLiveButton.selected){
        ...
        [self.modelEngineVoip pushStream:self.session url:self.live_url_textView.text view:self.liveRenderView];
        // [self.containerView addSubview:self.startPushLiveButton];
