...
// over network.
struct PacketOptions1 {
  PacketOptions1() : dscp(DSCP_NO_CHANGE), packet_id(-1) {}
  explicit PacketOptions1(DiffServCodePoint dscp) : dscp(dscp), packet_id(-1) {}
...
// received by socket.
struct PacketTime1 {
  PacketTime1() : timestamp(-1), not_before(-1) {}
  PacketTime1(int64_t timestamp, int64_t not_before)
...
inline PacketTime1 CreatePacketTime(int64_t not_before) {
  return PacketTime1(TimeMicros(), not_before);
}
...
class AsyncPacketSocket : public sigslot::has_slots<> {
 public:
  ...
  // Send a packet.
  virtual int Send(const void *pv, size_t cb, const PacketOptions1& options) = 0;
  virtual int SendTo(const void *pv, size_t cb, const SocketAddress& addr,
                     const PacketOptions1& options) = 0;
  ...
  sigslot::signal5<AsyncPacketSocket*, const char*, size_t,
                   const SocketAddress&,
                   const PacketTime1&> SignalReadPacket;
